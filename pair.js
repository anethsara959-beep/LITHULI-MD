...
const config = {
    ...
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/od7koi.jpg',
        MENU: 'https://files.catbox.moe/od7koi.jpg',
        OWNER: 'https://files.catbox.moe/od7koi.jpg',
        SONG: 'https://files.catbox.moe/od7koi.jpg',
        VIDEO: 'https://files.catbox.moe/od7koi.jpg'
    }
};
...
async function SendSlide(socket, jid, newsItems) {
    ...
    for (let item of newsItems) {
        ...
        try {
            ...
            imgBuffer = await Jimp.read('https://files.catbox.moe/od7koi.jpg');
        ...
        try {
            switch (command) {   
                ...
                case 'alive': {
                    ...
                    const content = `*ᴏᴡɴᴇʀ ʙʏ ◈Cᴇᴛʜᴀɴᴀ │ᴀᴅᴍɪɴ ʙʏ Lᴇʜᴀʀᴀ│Dɪʟꜱʜᴀɴ |  Sᴀɴᴜ xᴅ🐦‍🔥*\n` +                                   `ʙᴏᴛ ᴏᴡɴᴇʀ :- *Cᴇᴛʜᴀɴᴀ*\n` +
                                `*ʙᴏᴛ ɴᴀᴍᴇ :- LITHULI MD*\n` +
                                   `*ʙᴏᴛ ᴡᴇʙ ꜱɪᴛᴇ*\n` +
                                   `> *ᴄᴏᴍɪɴɢ ꜱᴏᴏɴ*`;
...
//=======================================
                ...
                case '.owner': {
                    ...
                    await socket.sendMessage(sender, {
                        contacts: {
                            displayName: "Cᴇᴛʜᴀɴᴀ OWNER",
                            contacts: [{ vcard }]
                        },
                        image: { url: config.BUTTON_IMAGES.OWNER },
                        caption: '*👑ʟɪᴛʜᴜʟɪ ᴍᴅ ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ*',
                        buttons: [
    ...
    await socket.sendMessage(sender, {
        image: { url: "https://files.catbox.moe/od7koi.jpg" },
        caption: formatMessage(title, content, footer)
    });
    break;
                }
                ...
                case '.song': {
                    try {
                        ...
                        const titleText = '*👑ʟɪᴛʜᴜʟɪ ᴍᴅ ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ*';
                        const content = `┏━━━━━━━━━━━━━━━━\n` +
                            `┃📝 \`Title\` : ${video.title}\n` +
                            `┃📈 \`Views\` : ${video.views}\n` +
...
await socket.sendMessage(userJid, {
    ...
    caption: formatMessage(
        ...
        'ᴏᴡɴᴇʀ ʙʏ ◈Cᴇᴛʜᴀɴᴀ │ᴀᴅᴍɪɴ ʙʏ Lᴇʜᴀʀᴀ│Dɪʟꜱʜᴀɴ |  Sᴀɴᴜ xᴅ🐦‍🔥'
    )
});
